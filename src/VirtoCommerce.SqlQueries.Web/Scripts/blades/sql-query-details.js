angular.module('VirtoCommerce.SqlQueriesModule')
    .controller('VirtoCommerce.SqlQueriesModule.sqlQueryDetailsController', [
        ...
        function ($scope, bladeNavigationService, dialogService, uiGridConstants, uiGridHelper, sqlQueriesApi) {
            ...
            function initializeToolbar() {
                blade.toolbarCommands = [
                    ...
                    {
                        name: 'Add parameter', //'sql-queries.commands.add-parameter',
                        icon: 'fa fa-plus',
                        executeMethod: function () {
                ...
                if (!blade.isNew) {
                    ...
                    blade.toolbarCommands.push({
                        name: 'Try query', //'sql-queries.commands.try-query',
                        icon: 'fa fa-play',
                        executeMethod: function () {
